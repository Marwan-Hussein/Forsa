    ...
    <div className="min-h-screen bg-[#eff6ff] py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <PageHeader
          ...
          titleIcon={<Sparkles className="h-8 w-8 text-[#EC9B3B]" />}
          actions={
            <button
              onClick={() => toast.info("Recommendations refreshed! (demo)")}
              className="flex items-center gap-2 rounded-lg border border-[rgba(82,109,130,0.2)] bg-white px-4 py-2 font-['Inter:Medium',sans-serif] text-[14px] font-medium text-[#27374d] transition-all duration-300 ease-in-out hover:border-[#27374d]/30 hover:bg-[#f8f9fa] active:scale-[0.98]"
            >
        ...
        <div className="mb-6 rounded-[14px] border-[0.8px] border-[rgba(82,109,130,0.2)] bg-white p-6">
          <div className="flex items-start gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#eff6ff]">
              <Sparkles className="h-6 w-6 text-[#EC9B3B]" />
            </div>
            <div className="flex-1">
              <h3 className="mb-2 font-['Inter:Semi_Bold',sans-serif] text-[16px] font-semibold text-[#27374d]">
                Personalized Just For You
              </h3>
              <p className="mb-3 font-['Inter:Regular',sans-serif] text-[14px] text-[#526d82]">
                Based on your interests: {userInterests.join(", ")}
              </p>
              <Link
                to="/interests"
                className="inline-flex items-center gap-2 font-['Inter:Medium',sans-serif] text-[14px] font-medium text-[#27374d] transition-colors duration-300 ease-in-out hover:text-[#1e2936]"
              >
        ...
        {recommendedEvents.length > 0 && (
          <div className="mb-12">
            <h2 className="mb-6 font-['Inter:Semi_Bold',sans-serif] text-[24px] font-semibold text-[#27374d]">
              Top Picks For You
            </h2>
        ...
        {recommendedEvents.length === 0 && otherEvents.length === 0 && (
          <div className="rounded-[14px] border-[0.8px] border-[rgba(82,109,130,0.2)] bg-white p-12 text-center">
            <Sparkles className="mx-auto mb-4 h-16 w-16 text-[#526d82]" />
