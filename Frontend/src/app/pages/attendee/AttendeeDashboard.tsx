      ...
      >
        ...
        <div className="w-full md:w-56 bg-slate-50 p-6 flex flex-col justify-between items-center text-slate-700">
          ...
          <button 
            ...
            className="w-full mt-4 bg-white hover:bg-[var(--brand-navy)] text-[var(--brand-navy)] hover:text-white border border-[var(--brand-navy)]/15 hover:border-transparent font-bold text-xs py-2 px-3 rounded-lg shadow-sm hover:shadow-md transition-all text-center flex items-center justify-center gap-1.5"
          >
