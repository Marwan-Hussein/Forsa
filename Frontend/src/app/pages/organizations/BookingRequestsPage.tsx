    ...
    <div className="min-h-screen bg-[#eff6ff]">
      <main className="px-6 py-8 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-[#27374d] mb-2">Booking Requests</h1>
          <p className="text-[#526d82]">Manage attendee booking requests for your events</p>
        </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      <h3 className="text-xl font-bold text-[#27374d]">{request.attendeeName}</h3>
                      <span
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-[#526d82] mb-3">
                    ...
                    {request.specialRequests && (
                      <div className="p-3 bg-[#eff6ff] rounded-lg mb-3">
                        <p className="text-sm text-[#526d82]">
                          <strong className="text-[#27374d]">Special Requests:</strong> {request.specialRequests}
                        </p>
                      </div>
                    )}
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-6 z-50 cursor-pointer hover:bg-black/55" onClick={() => setSelectedRequest(null)}>
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Attendee Info */}
              <div>
                <h3 className="text-lg font-bold text-[#27374d] mb-3">Attendee Information</h3>
                <div className="space-y-2 text-[#526d82]">
                  <p><strong className="text-[#27374d]">Name:</strong> {selectedRequest.attendeeName}</p>
                  <p><strong className="text-[#27374d]">Email:</strong> {selectedRequest.attendeeEmail}</p>
                  <p><strong className="text-[#27374d]">Phone:</strong> {selectedRequest.attendeePhone}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-[#526d82]">
                  <p><strong className="text-[#27374d]">Event:</strong> {selectedRequest.eventTitle}</p>
                  <p><strong className="text-[#27374d]">Tickets Requested:</strong> {selectedRequest.tickets}</p>
                  <p><strong className="text-[#27374d]">Request Date:</strong> {new Date(selectedRequest.requestDate).toLocaleDateString()}</p>
                </div>
              </div>

              {selectedRequest.specialRequests && (
                <div>
                  <h3 className="text-lg font-bold text-[#27374d] mb-3">Special Requests</h3>
                  <p className="text-[#526d82]">{selectedRequest.specialRequests}</p>
                </div>
              )}
