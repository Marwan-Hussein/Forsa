                  ...
                  <div className="flex-1 relative z-10">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1 pr-4">
                        ...
                        <span className={`inline-flex items-center px-3 py-1.5 rounded-xl text-xs uppercase tracking-wider font-bold shadow-sm ${
                            event.status === 'Cancelled' || event.status === '3' 
                              ? "bg-rose-100 text-rose-700 border border-rose-200" 
                              : event.status === 'Completed' || event.status === '2'
