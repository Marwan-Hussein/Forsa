...
export default function ForgotPasswordPage() {
  ...
  try {
    await apiPost("/api/auth/register/resend", {
      email,
    });
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col p-12 border-r border-white/5">
        ...
        <div className="relative z-10 mt-auto space-y-4">
          <h2 className="text-3xl font-black text-white tracking-tight leading-tight">
            Verify your <br />Forsa account
          </h2>
          <p className="text-slate-300 text-sm max-w-md font-medium leading-relaxed">
            Enter your email and we'll send you a secure 6-digit verification code to Verify Your Account.
          </p>
        </div>
      </div>
