...
| 2. [Mariam Ehab](https://github.com/Marria-m)            | [LinkedIn](https://www.linkedin.com/in/mariamehab1305)              | - Upload & Images Sync (Profile, Place, Event)<br>- Event Sharing, User Profiles, Admin Block/Unblock)<br>- QR Attendance System (Organizer scans attendees)<br>- Event Booking (Attendee books events)<br>- Venue Booking Request (Organizer requests place for event)<br>- Owner Features<br>- Policy-Based Authentication                                                                                                                |
